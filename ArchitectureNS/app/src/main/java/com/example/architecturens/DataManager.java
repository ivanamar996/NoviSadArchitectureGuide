...
public class DataManager {
   ...
   private void initializeRoutes() {
    ...
    private RouteInfo initRoute1() {
        ...
        places.add(new PlaceInfo("place1","Katedrala","Katedrala je jedna od najbitnijih znamenitosti centra,kao i samog Novog Sada."));
        places.add(new PlaceInfo("place2", "Katolicka Porta", "Porta se nalazi iza katedrale i sadrzi veci broj ugostiteljskih objekata."));
        places.add(new PlaceInfo("place3", "Zmaj Jovina ulica", "Navedena ulica predstavlja setaliste i nema saobrcaja u njoj. Ljudi rado setaju tom ulicom."));
        return new RouteInfo("route1", "Centar", places, 2, "Centar grada je jako lijep i prepun raskosnih gradjevina iz doba austrougarske.", 10,"drawable/image1.jpg" );
    }
